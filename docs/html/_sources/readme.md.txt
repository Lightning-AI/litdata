...
CLI <https://aws.amazon.com/cli/>`__ to `AWS
...
-  `Subsample and split your
   datasets <#subsample-and-split-your-datasets>`__
-  `Append or Overwrite optimized
   datasets <#append-or-overwrite-optimized-datasets>`__
...
-  `Support S3-Compatible Object
   Storage <#support-s3-compatible-object-storage>`__
...
Integrate S3-compatible object storage servers like
`MinIO <https://min.io/>`__ with litdata, ideal for on-premises
infrastructure setups. Configure the endpoint and credentials using
...
Alternatively, configure credentials and endpoint in
...
Explore an example setup of litdata with MinIO in the `LitData with
MinIO <https://github.com/bhimrazy/litdata-with-minio>`__ repository for
