...
from lightning_data.processing import data_processor as data_processor_module
from lightning_data.processing import functions
from lightning_data.processing.data_processor import (
    DataChunkRecipe,
    DataProcessor,
    DataTransformRecipe,
...
from lightning_data.processing.functions import LambdaDataTransformRecipe, map, optimize
from lightning_data.streaming import resolver
from lightning_data.streaming.cache import Cache, Dir
...
@pytest.mark.skipif(condition=sys.platform == "win32", reason="Not supported on windows")
@mock.patch("lightning_data.processing.data_processor._wait_for_disk_usage_higher_than_threshold")
...
def test_wait_for_disk_usage_higher_than_threshold():
    ...
    with mock.patch("lightning_data.processing.data_processor.shutil.disk_usage", disk_usage_mock):
